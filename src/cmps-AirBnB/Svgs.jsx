export const svgIcons = {
    AirBnB: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ display: 'block', fill: '#ce2e6c', height: '24px', width: '24px', stroke: 'var(--linaria-theme_palette-icon-primary-inverse)', strokeWidth: '2', overflow: 'visible' }}>
    ...
    heart: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ display: 'block', fill: 'rgba(0, 0, 0, 0.5)', height: '24px', width: '24px', stroke: 'var(--linaria-theme_palette-icon-primary-inverse)', strokeWidth: '2', overflow: 'visible' }}>
